...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_StorageManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StorageManager_t qt_meta_stringdata_StorageManager = {
    {
QT_MOC_LITERAL(0, 0, 14), // "StorageManager"
QT_MOC_LITERAL(1, 15, 12), // "previewReady"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 9), // "captureID"
QT_MOC_LITERAL(4, 39, 5) // "image"

    },
    "StorageManager\0previewReady\0\0captureID\0"
    "image"
};
...
void StorageManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->previewReady((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QImage(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (StorageManager::*)(int , QImage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StorageManager::previewReady)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject StorageManager::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_StorageManager.data,
...
// SIGNAL 0
void StorageManager::previewReady(int _t1, QImage _t2)
{
