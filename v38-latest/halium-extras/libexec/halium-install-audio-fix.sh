...

{
    ...
    #
    # НАЙДЕНО 2026-07-27 (v23): libasound2-plugins:arm64/:armhf собраны с
    # разным содержимым общего /etc/alsa/conf.d/99-pulseaudio-default.
    # conf.example -- --force-overwrite безопасен, файл не активный конфиг.
